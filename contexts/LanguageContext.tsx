...
const translations = {
  ...
  fr: {
    ...
    // Offer page
    'offer.title': 'Découvre ton vrai potentiel',
    'offer.subtitle': 'Obtenez une analyse honnête et détaillée de votre apparence',
    ...
    'offer.no_credits_message': 'Vous devez acheter des crédits pour obtenir plus d\'évaluations faciales',
    'offer.back_button': 'Retour',
    'offer.one_time_payment': 'Paiement unique',
    'offer.get_critiques': 'Obtenez {{amount}} photos à analyser',
    'offer.what_you_get': 'Ce que vous obtenez',
    'offer.benefit_truth': 'Découvrez la vérité sur votre apparence',
    'offer.benefit_improve': 'Améliorez votre apparence avec des conseils précis',
    'offer.benefit_confidence': 'Gagnez en confiance en connaissant vos points forts',
    'offer.benefit_professional': 'Analyse professionnelle basée sur les standards mondiaux',
    'offer.benefit_forever': 'Accès à vie - consultez vos résultats quand vous voulez',
    'offer.benefit_pdf': 'Guide PDF personnalisé pour transformer votre apparence',
    'offer.results_title': 'Résultats concrets',
    'offer.results_desc': 'Découvrez exactement ce qui fonctionne et ce qui peut être amélioré',
    ...
    'offer.feature_brutal_honesty': 'Brutalement honnête',
    'offer.feature_score_100': 'Score sur 100 selon les standards mondiaux',
    'offer.feature_ai_analysis': 'Analyse IA experte et retours détaillés',
    'offer.feature_improvement_tips': 'Conseils d\'amélioration et conseils de style',
    'offer.feature_final_verdict': 'Verdict final et évaluation complète',
    'offer.feature_access_forever': 'Accès à vie - pas d\'expiration',
    'offer.feature_pdf_improvement': 'PDF avec exactement comment améliorer son apparence',
    ...
    'offer.face_rating_example_brutal': 'Exemple d\'évaluation faciale - retour brutalement honnête',
    'offer.face_rating_example_expert': 'Exemple d\'évaluation faciale - analyse experte',
